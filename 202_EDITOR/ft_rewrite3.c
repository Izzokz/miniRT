...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/07/27 09:52:45 by kzhen-cl          #+#    #+#             */
/*   Updated: 2025/07/27 09:52:46 by kzhen-cl         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "miniRT.h"

char	rewrite_cone2(char **tokens, t_vec tmp_v[2], double tmp_d[2])
{
...
static inline char	bad_tokens_cone(char **tokens)
{
...
char	rewrite_cone(t_obj *obj, char **tokens)
{
	...
	if (bad_tokens_cone(tokens)
		|| rewrite_cone2(tokens, tmp_v, tmp_d) == PARSE_KO)
		return (PARSE_KO);
